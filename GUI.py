...
class RecognizeFace:
    ...
    def returnImg(self):
        ...
        for (top, right, bottom, left), name in zip(self.face_locations, self.face_names):
            ...
            # 네모 옆에 글씨써주기
            received_image = cv2.rectangle(received_image, (left, bottom - 35), (right, bottom), (0, 0, 255),
                                           cv2.FILLED)
            font = cv2.FONT_HERSHEY_DUPLEX
            received_image = cv2.putText(received_image, name, (left + 6, bottom - 6), font, 3.0, (255, 255, 255), 3)
...
class View:
    ...
    def __init__(self, init):
        ...
        self.font_title = ("San Francisco", 20, "bold")
        self.font_button = ("San Francisco", 15, "bold")
        self.font_little = ("San Francisco", 10, "bold")
        ...
        self.entry_slide2_left_nameInput.bind("<FocusIn>",
                                              lambda args: self.entry_slide2_left_nameInput.delete(0, tk.END))
